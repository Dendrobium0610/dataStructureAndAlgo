...
typedef void (*fptrRemove)(list_t *Obj, uint32_t num);
typedef void (*fptrShow)(list_t *Obj);
typedef void (*fptrInsert)(list_t *Obj, uint32_t num, int32_t val);
typedef void (*fptrDelete)(list_t *Obj, uint32_t num);
